...
<tr>
<td>
Выбирите первый файл для загрузки: 
</td>
<td align="center"><input type="hidden" name="MAX_FILE_SIZE" value="900000"><input name="pictures[]" type="file"></td>
</tr>
<tr>
<td>
Выбирите второй файл для загрузки: 
</td>
<td align="center"><input type="hidden" name="MAX_FILE_SIZE" value="900000"><input name="pictures[]" type="file"></td>
</tr>
<tr>
...
echo 'Ошибка, файлы не могут быть загружены.';	
}
}
?>
